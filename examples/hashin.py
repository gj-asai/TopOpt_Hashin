...
solver = TopOpt(inputfile='models/plate_hole.db', res_dir='results/hashin/', jobname='hashin', topology=False, orientation='hashin')
...
solver.set_optim_options(max_iter=50)

solver.run()
solver.save()

# solver = TopOpt.load('results/hashin/topopt.json')
